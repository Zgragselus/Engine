...
// IndexBuffer.h
//
// Following file defines OpenGL IndexBuffer class (Element Array Buffer Objects)
// 
///////////////////////////////////////////////////////////////////////////////////////////////////
//
...
#ifndef __INDEX_BUFFER__H__
#define __INDEX_BUFFER__H__
...
namespace Engine
{
	...
	public:
		...
		IndexBuffer(void* ptr, size_t sizeOfItem, size_t noOfElements, GLenum usage)
		{
			itemSize = sizeOfItem;
			items = noOfElements;
			size = itemSize * items;
			...
			glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, glData);
		...
		void Synchronize(bool deviceToHost)
		{
			...
			{
				glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, glData);
				void* gpuPtr = glMapBuffer(GL_ELEMENT_ARRAY_BUFFER, GL_READ_ONLY);
			...
			{
				glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, glData);
				void* gpuPtr = glMapBuffer(GL_ELEMENT_ARRAY_BUFFER, GL_WRITE_ONLY);
		...
		/// <summary>
		/// Enable the index buffer object
		/// </summary>
		void Enable()
		{
			glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, glData);
		...
		/// <summary>
		/// Disable the index buffer object
		/// </summary>
		void Disable()
		{
			glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0);
		...
		ALIGNED_NEW_DELETE("Engine::Graphics::IndexBuffer")
	};
}
